    ...
    <>
      <div className="container">
        ...
        <p style={{ maxWidth: "1000px" }}>
          ...
          will introduce your brand&apos;s persona to your audience. This will
          help build a connection between you and them.
        </p>
      </div>
      <div className="row">
        <div
          style={{ textAlign: "center" }}
          className="col-md-6 my-5 bg-blue text-white p-5"
        >
